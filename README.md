...
<ol>
  ...
  <li>Obtén tu API Key desde el servicio de API correspondiente. Guarda la clave en el archivo <code>local.properties</code> de tu proyecto, agregando la siguiente línea:
